...
Функция SubGraphsInscribed применена после переработки в проекте https://graphonline.ru/ (https://github.com/UnickSoft/graphonline) для проверки изоморфности графов и поиска подграфа по образцу.
***
