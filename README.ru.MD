...
"Вписанный" здесь значит, что найденные подграфы могут быть соединены с оставшейся частью графа A только через крайние вершины максимальных неразветвляющихся путей данных подграфов, либо "концевые пути" будут содержаться в каком-либо из неразветвляющихся путей в А.
