...
vector, set, algorithm, queue, map, cmath, stack, limits.h, cstdlib, ctime, float.h, необходимых 
...
PPS Настоящая версия CBioInfCpp.h имеет кодировку 866, что может вызывать некорректное отображение
кириллических символов здесь. Однако при скачивании файлов и открытии в нужной кодировке эта проблема исчезает.
